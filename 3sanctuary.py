...
keyboard.type(' ') # 31
time.sleep(3)
mouse.position = (1138, 149)
time.sleep(0.1)
mouse.click(Button.left)
time.sleep(0.1)
mouse.position = (579, 647)
time.sleep(0.1)
mouse.click(Button.left)
time.sleep(1.9)
color(1214, 659, [255,255,255], 20, 10000, 0.1)
