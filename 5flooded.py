...
keyboard.release(Key.backspace)
time.sleep(0.1)
mouse.position = (252, 341)
time.sleep(0.1)
mouse.click(Button.left)
time.sleep(0.1)
keyboard.type('/')
time.sleep(0.1)
mouse.position = (376, 346)
time.sleep(0.1)
mouse.click(Button.left)
time.sleep(0.1)
keyboard.type('.')
